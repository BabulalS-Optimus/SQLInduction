...
--Run these queries to insert the data in [t_emp] table
...
--Run these queries to insert the data in [t_activity] table
...
--Run these queries to insert the data in [t_atten_det] table
...
--Run these queries to insert the data in [t_salary] table
